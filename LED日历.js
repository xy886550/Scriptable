...
const ImageMode = false   //选择true时，使用壁纸
...
//写入当前时间
  ...
  Now.applyTimerStyle()
  Now.font = new Font('GillSans-UltraBold', 45)
//细AvenirNext-UltraLight HelveticaNeue-UltraLight PingFangSC-Ultralight
//粗Futura-CondensedExtraBold GillSans-UltraBold DBLCDTempBlack PartyLetPlain Chalkduster MarkerFelt-Wide
  Now.textColor = new Color("ffffff")
  Now.textOpacity = 1 //文本不透明度
  Now.centerAlignText()
  Now.shadowColor = new Color("000000") //阴影颜色
  Now.shadowRadius = 0  //阴影半径
