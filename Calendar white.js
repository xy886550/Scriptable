...
var settings = {
  ...
  markToday: true,
  todayCircleColor: "#ff0000",
  showEventCircles: false,
  eventCircleColor: "#545454",
  weekdayTextColor: "#000000",
  weekendLetters: "#808080",
  weekendLetterOpacity: 1,
  weekendDates: "#808080",
  locale: "en-ZH",
  textColor: "#000000",
  eventDateTimeOpacity: 1,
...
function getWeekLetters(locale = "en-ZH", startWeekOnSunday = false) {
  let week = [];
  for (let i = 1; i <= 7; i += 1) {
